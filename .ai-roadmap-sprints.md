...
### Week 1: Design Refresh & Smyck Integration
**Sprint Goal:** Implement Smyck color scheme for articles while maintaining site simplicity

**Tasks:**
- [ ] Research and document Smyck color scheme values from GitHub repo
- [ ] Create new CSS variables for article color theming  
- [ ] Update `assets/css/insight.css` with Smyck-inspired color palette
...
**Deliverables:**
- Updated insight.css with Smyck theme integration
...
- [ ] Create article preview cards with Smyck color accents
